...
export function LeftDirectionalPad({gamepad}: ILeftDirectionalPadProps) {
	...
	return (
		<g>
			<circle className={OutlineStyle} cx='166' cy='238' r='37.5'/>
			<path className={upButtonClassName} d={up}/>
			<path className={rightButtonClassName} d={right}/>
			<path className={downButtonClassName} d={down}/>
			<path className={leftButtonClassName} d={left}/>
		</g>
	)
}