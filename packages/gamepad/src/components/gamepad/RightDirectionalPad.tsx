		...
		<g>
			...
			<g id='BTop'>
				<mask id='path-13-inside-5' fill='white'>
					<path
						d='M340.669 144.335C343.793 141.21 343.816 135.997 339.868 134.014C339.327 133.743 338.776 133.491 338.215 133.258C335.182 132.002 331.931 131.355 328.648 131.355C325.365 131.355 322.114 132.002 319.081 133.258C318.521 133.491 317.969 133.743 317.429 134.014C313.48 135.997 313.503 141.21 316.627 144.335L322.991 150.698C326.116 153.823 331.181 153.823 334.305 150.698L340.669 144.335Z'></path>
				</mask>
				<path className={topButtonClassName}
					...
					fill='rgba(0,0,0,0)' stroke='rgba(0,0,0,1)' strokeWidth='10' mask='url(#path-13-inside-5)'></path>
			</g>
			<g id='BRight'>
				...
				<path className={rightButtonClassName}
					...
					fill='rgba(0,0,0,0)' stroke='rgba(0,0,0,1)' strokeWidth='10' mask='url(#path-14-inside-6)'></path>
			</g>
			<g id='BBottom'>
				...
				<path className={bottomButtonClassName}
					...
					fill='rgba(0,0,0,0)' stroke='rgba(0,0,0,1)' strokeWidth='10' mask='url(#path-15-inside-7)'></path>
			</g>
			<g id='BLeft'>
				...
				<path className={leftButtonClassName}
					...
					fill='rgba(0,0,0,0)' stroke='rgba(0,0,0,1)' strokeWidth='10' mask='url(#path-16-inside-8)'></path>
			</g>
		</g>
	)
}